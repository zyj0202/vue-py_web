...
#将第三方应用放到extra_apps下
# django_ueditor  因为这个第三方富文本包目前没没有与django3版本所以需要修改源码才能在django3下使用
...
SECRET_KEY = 'a7%wjfh7#t!d$t^@fefo5dy^jbm%h+p247u3qhkl6u8i7^)rij'
...
# 因为使用富文本编辑时两种不同上传图片的原因，上传单个需要配置同源
